...
\begin{abstract}
U nastavku su predstavljeni blokovi aktivnog pomerača faze sa vektorskim modulatorom za tehnologiju IHP SiGe BiCMOS 130nm. Pomerač faze je kontrolisan 8-bitnim digitalno analognim konvertorom.
\end{abstract}
...
Kao i RC-CR filtar, ni QAF nije imun na opterećivanje izlaza kapacitvnošću i zbog toga se koristi diferencijalni QAF. Izvođenje diferencijalnog kola iz kvadraturnog \textit{all-pass} filtra je prikazano na slici ~\ref{fig:qaf_diff}, i iskorišćena je 
...
Za kalemove u kombajneru je bitno da imaju što bolji Q faktor kako bi pojačanje \textit{VGA} bilo što veće!
...
Na slikama ~\ref{fig:gain_error} i ~\ref{fig:phase_error} se mogu videti greške faze i pojačanja na opsezima učetanosti.
...
NAPOMENA:
Dati grafici su prikazani samo zarad testiranja ograničenja i mogućnosti tehnologije i topologije za neke kritične aspekte pomerača, i nisu simulirani za identične blokove, jer su oni skloni promenama.
...
\begin{figure}[!htbp]
  ...
  \caption{Amplituda i faza izlaza jednog dela vektor modualtora}
