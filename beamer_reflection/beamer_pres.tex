...
\begin{frame}{Uvod}{Optional Subtitle}
  \begin{itemize}
  \item {
    My first point.
  }
...
\begin{frame}{Fazirani nizovi}
	\begin{figure}[!htbp]
		\centering
		\includegraphics[width=0.5\linewidth]{beam_forming_transmitter.png}
		\caption{\textit{Beamforming} predajnik}
		\label{fig:beam_forming_transmitter}
	\end{figure}
\end{frame}
